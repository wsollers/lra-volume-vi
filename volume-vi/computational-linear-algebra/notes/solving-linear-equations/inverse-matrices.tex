...
\begin{tcolorbox}[colback=gray!6, colframe=gray!40, arc=2pt,
  ...
  title={\small\textbf{Inverse Matrices --- Quick Reference}},
...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Invertible Matrix)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Properties of Inverses)}},
  fonttitle=\small\bfseries]
...
This means a Bézier curve has the matrix form
\[
  C(u) = [u^i]^T M [P_i],
\]
...
Bézier control points are $[P_i] = M^{-1}[\mathbf{a}_i]$.
