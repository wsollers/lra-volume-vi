...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{lem:computational-geometry-linear-functionals-convex-combinations}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:computational-geometry-monotone-slope-upper-hull}.
\end{itemize}
\end{dependencies}
