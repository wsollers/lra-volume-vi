...
discussion in the legacy Algebraic Structures chapter. This predicate now
feeds the Boolean-ring definition in the Rings section
(Definition~\ref{def:boolean-ring}).
\end{remark*}
